...
import struct
# adapted from https://raw.githubusercontent.com/ajalt/python-sha1/4f9306d271e39e354c695ca6fb66d3f598dab64b/sha1.py
...
def sha1(message, registers=None, offset=0):
    ...
    for i in range(offset, len(message), 64):
        w = [0] * 80
    ...
    return b'%08x%08x%08x%08x%08x' % (h0, h1, h2, h3, h4)
...
if __name__ == '__main__':
    input = b"hello\n"
    print(sha1(input))
    print(sha1_mac(b"yellow_submarine", input))
